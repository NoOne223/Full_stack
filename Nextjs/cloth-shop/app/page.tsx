        ...
        <div className="container mx-auto p-3">
          <div className="flex">
            <div className="w-1/2 grid grid-cols-2 gap-5">
              ...
              <div className="border border-transparent bg-white text-thirdary p-5">
              ...
              <div className="border border-transparent bg-thirdary text-white p-5 content-center">
                <h2 className="text-6xl capitalize">Trang thời trang hiện đại</h2>
              </div>
            </div>
            <div className="w-1/2 relative">
              <div>
                <Image src='/images/modal-women.png' width={500} height={500} alt="Modal"/>
              </div>
            </div>
          </div>
        </div>
